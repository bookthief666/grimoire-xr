...
Last audited: 2026-08-10 on `codex/quad-draw-consolidation`, stacked from PR #28 head `07b6303f320f8ff345bc4b57c22a61f48d3e6a1b`.
...
| The Monad | `tools/monas.ts`, `MonadChamber.tsx` | Six ordered construction phases; advance/reset; staged spatial glyph; phase progress; construction description and commentary; collapsed/exploded construction view | The composite glyph is assembled as a persistent architectural construction whose six layers can separate in depth without losing the ordered whole | No user-controlled scale, free alternate viewing angle, or complete sourced 24-theorem edition. Current six stages are an application-authored pedagogical sequence, not full historical parity with the source work. | Every current stage remains operative reconstruction; application text is not presented as Dee quotation or as Theorems I–VI | Fully offline | Light; completed flat view reduced from 329 to 187 matched mono draws | Phase order/provenance/merged-geometry tests pass; production build passes. Flat layout and draw evidence captured; source-layout, controller, and headset-scale QA required. |
