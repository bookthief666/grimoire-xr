...
if (app.includes('window.confirm(')) fail('native browser confirmation is still present');
if (!app.includes('<ContinuityReturnDialog')) fail('themed continuity return dialog did not activate');
