...
const RootApp = lazy(() => {
  if (routeId === APP_ROUTE_IDS.livingTriadCurrentQa) return import('./tarotBridge/LivingTriadCurrentQaApp.jsx');
  if (routeId === APP_ROUTE_IDS.livingRelicQa) return import('./tarotBridge/LivingRelicQaApp.jsx');
