  ...
  return (
    ...
    >
      ...
      <Text
        ...
        fontSize={0.04}
        color={disabled ? '#6d5135' : hovered ? '#ffffff' : '#ff95a3'}
        anchorX="center"
        anchorY="middle"
        maxWidth={width - 0.03}
      >
...
function SpreadMandala({
  ...
  return (
    <group>
      ...
      <TableBar a={[-0.82, 0.44]} b={[0.82, 0.44]} color="#8a35ff" opacity={0.22} width={0.01} />
      <TableBar a={[-0.82, -0.44]} b={[0, 0.62]} color="#ff7a8f" opacity={0.26} width={0.012} />
      <TableBar a={[0.82, -0.44]} b={[0, 0.62]} color="#ff7a8f" opacity={0.26} width={0.012} />
      ...
      {[
        ...
        <group key={`${glyph}-${index}`} position={[Number(x), TABLE_Y + 0.046, Number(z)]}>
          <mesh rotation={[-Math.PI / 2, 0, 0]}>
            ...
            <meshBasicMaterial
              color={index < occupied ? '#ff95a3' : '#5d2831'}
              transparent
          ...
          <Text
            ...
            rotation={[-Math.PI / 2, 0, 0]}
            fontSize={0.038}
            color={index < occupied ? '#fff0c0' : '#5d2831'}
            anchorX="center"
            anchorY="middle"
          >
            {String(glyph)}
...
function SpreadSlot({
  ...
  const cornerColor = active ? '#ff7a8f' : '#5d2831'
    ...
    >
      ...
      <mesh position={[0, 0.12, 0.025]}>
        ...
        <meshBasicMaterial
          ...
          color={selected ? '#ff7a8f' : hovered ? '#d93a57' : '#6e0d1b'}
          transparent
      ...
      <Text
        ...
        fontSize={0.022}
        color={card.artPrompt ? '#d9b5ff' : '#5d2831'}
        anchorX="center"
        anchorY="middle"
        maxWidth={0.26}
      >
  ...
  return (
    <group position={[-1.05, 0.98, 0.08]} scale={0.98}>
      ...
      <mesh position={[0, 0, 0.012]}>
        ...
        <meshBasicMaterial
          color={hasSavedRitual ? '#8a35ff' : '#8f1022'}
          transparent
      ...
      <Text
        ...
        fontSize={0.028}
        color={hasSavedRitual ? '#d9b5ff' : '#914052'}
        anchorX="center"
        anchorY="middle"
        maxWidth={1.18}
      >
  ...
  return (
    <group position={[0, 0.82, -0.84]} scale={WORKBENCH_SCALE}>
      ...
      <Text
        ...
        rotation={[-Math.PI / 2, 0, 0]}
        fontSize={0.04}
        color={loading || oracleLoading ? '#ff7a8f' : '#9a6b48'}
        anchorX="center"
        anchorY="middle"
        maxWidth={1.7}
      >
